...
public class DonHangCuaBanAdapter extends RecyclerView.Adapter<DonHangCuaBanAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public DonHangCuaBanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.iteam_donhangcuaban, parent, false);
        return new DonHangCuaBanAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DonHangCuaBanAdapter.ViewHolder holder, int position) {
